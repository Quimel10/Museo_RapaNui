...
/// 👉 No rompe nada.
/// 👉 Permite compilar.
/// 👉 Más adelante puedes meter analíticas reales.
final analyticsProvider = Provider<AnalyticsService>((ref) {
  return AnalyticsService();
});

class AnalyticsService {
  void clickCategory(dynamic id, {Map<String, dynamic>? meta}) {
    // NO-OP
  }

  void clickObject(dynamic id, {Map<String, dynamic>? meta}) {
    // NO-OP
  }

  void clickBanner(dynamic id, {Map<String, dynamic>? meta}) {
    // NO-OP
  }
}
